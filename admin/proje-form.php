...
<form method="post" enctype="multipart/form-data" class="card p-4">
  ...
  <div class="row g-3">
    ...
    <div class="col-md-4"><label class="form-label">Kategori</label><input class="form-control" name="kategori" value="<?= e($p['kategori']) ?>" placeholder="İnşaat / Hafriyat / Nakliyat"></div>
