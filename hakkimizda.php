...
<section>
  <div class="container">
    <div class="row align-items-center g-5">
      <div class="col-lg-6">
        <div class="about-img">
          <img src="https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=1000&q=80" alt="">
      ...
      <div class="col-lg-6">
        ...
        <ul class="about-list">
          <li><i class="bi bi-check-circle-fill"></i> İnşaat, hafriyat ve nakliyat alanında uzman</li>
          <li><i class="bi bi-check-circle-fill"></i> Modern ekipman ve iş makinesi parkı</li>
          <li><i class="bi bi-check-circle-fill"></i> İş güvenliği standartlarına tam uyum</li>
          <li><i class="bi bi-check-circle-fill"></i> Çevreye duyarlı çalışma anlayışı</li>
        </ul>
      </div>
    </div>
  </div>
